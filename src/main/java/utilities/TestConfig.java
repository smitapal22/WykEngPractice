...
public class TestConfig {
	...
	public static String from = "smitapal22@gmail.com";
	public static String password = "Komal@123#";
	public static String[] to ={"smitapal22@gmail.com","smitapal_br@hotmail.com"};
